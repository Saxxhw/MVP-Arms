...
class ClusterOverlay(
     ...
     */
    class AnimationListener(removeMarkers: List<Marker>) : Animation.AnimationListener {

        private val mRemoveMarkers: MutableList<Marker> = removeMarkers.toMutableList()
